use crate::renderer::draw::primitive::path;
use crate::renderer::draw::primitive::{PathStroke, Primitive};
use crate::renderer::draw::properties::spatial::{orientation, position};
use crate::renderer::draw::properties::{
    ColorScalar, SetColor, SetOrientation, SetPosition, SetStroke,
};
use crate::renderer::draw::{self, Drawing};
use lyon::tessellation::StrokeOptions;
use nannou::color::LinSrgba;
use nannou::geom::{self, pt2, Point2};
use nannou::math::{BaseFloat, Zero};
