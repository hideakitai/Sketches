...
fn main() -> Result<()> {
    ...
    // paths_to_copy.push("../assets/learn_wgpu");
    // copy_items(&paths_to_copy, out_dir, &copy_options)?;

    // let asset_relative_path = "../assets/learn_wgpu";
    // println!("cargo:rerun-if-changed={}*", &asset_relative_path);
    // let out_dir = env::var("OUT_DIR")?;
    // let mut copy_options = CopyOptions::new();
    // copy_options.overwrite = true;
    // let mut paths_to_copy = Vec::new();
    // paths_to_copy.push(asset_relative_path);
    // copy_items(&paths_to_copy, out_dir, &copy_options)?;
