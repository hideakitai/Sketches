...
pub fn create_uniform_buffer_copiable<T: bytemuck::Pod>(
    device: &wgpu::Device,
    contents: &T,
) -> wgpu::Buffer {
    device.create_buffer_init(&wgpu::util::BufferInitDescriptor {
...
pub fn create_vertex_buffer(device: &wgpu::Device, vertices: &[GeomVertex]) -> wgpu::Buffer {
    device.create_buffer_init(&wgpu::util::BufferInitDescriptor {
...
pub fn create_storage_buffer<T: bytemuck::Pod>(device: &wgpu::Device, instance_data: &[T]) -> wgpu::Buffer {
    device.create_buffer_init(&wgpu::util::BufferInitDescriptor {
...
pub fn create_buffer_from_descriptor(
    device: &wgpu::Device,
...
pub fn create_bind_group_from_buffers(
    device: &wgpu::Device,
...
pub fn create_bind_group_from_textures(
    device: &wgpu::Device,
    layout: &wgpu::BindGroupLayout,
